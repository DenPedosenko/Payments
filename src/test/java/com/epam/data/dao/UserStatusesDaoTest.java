...
public class UserStatusesDaoTest {
	...
	@Test
	public void shouldReturnUserStatusByName() {
		UserStatus actual = UserStatusDao.getStatus(connection,  "Active","en");
		UserStatus expected = new UserStatus(1, "Active");
		assertEquals(expected, actual);
	}
	
	@Test
	public void shouldReturnUserStatusById() {
		UserStatus actual = UserStatusDao.getStatus(connection,  "Active","en");
		UserStatus expected = new UserStatus(1, "Active");
		assertEquals(expected, actual);
	}
